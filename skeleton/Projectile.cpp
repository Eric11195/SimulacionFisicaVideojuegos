...
void Projectile::integrate(double dt)
{
	...
	//F = m * a, as� que si solo le a�ado todas las fuerzas a accel. Antes de poder a�adirselo a la velocidad tengo que dividirlo por la masa (o multiplicarlo por la masa inversa)
	accel *= mass.inv_mass;
